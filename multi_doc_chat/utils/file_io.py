        ...
        for uf in uploaded_files:
            ...
            with open(out, "wb") as f:
                ...
                if hasattr(uf, "file") and hasattr(uf.file, "read"):
                    ...
                    data = uf.read()
                    # Normalize to bytes for file writes and satisfy type checkers.
                    if isinstance(data, memoryview):
                        data = data.tobytes()
                    elif not isinstance(data, (bytes, bytearray)):
                        raise TypeError("Uploaded file read() did not return a bytes-like object")
                    f.write(data)
                else:
                    ...
                    if callable(buf):
                        ...
                        if isinstance(data, memoryview):
                            ...
                            raise TypeError("Uploaded file getbuffer() did not return a bytes-like object")
                        f.write(data)
                    else:
